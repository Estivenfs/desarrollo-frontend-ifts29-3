...
const TeamCarousel3D = ({ 
  ...
  // Observa visibilidad de tarjetas en móviles para activar barras sin hover
  useEffect(() => {
    if (!isMobile) return;
      ...
      >
        ...
        >
          {integrantes.map((integrante, index) => {
            const isActive = (hoveredCard === index) || (isMobile && visibleCards.has(index));
            return (
              <div 
                key={index}
              ...
              >
                <div 
                  className={`card team-card h-100 ${isMobile && visibleCards.has(index) ? 'visible' : ''}`} 
                  ...
                  style={{ 
                    background: (!isMobile && index === currentSlide)
                      ? 'linear-gradient(135deg, rgba(0,0,0,1), rgba(30,30,30,1))'
                  ...
                  <div style={{ 
                    ...
                    <div style={{ marginTop: 'auto' }}>
                      ...
                      <p style={{
                        ...
                        {isMobile ? 'Se revela al ser visible en la pantalla' : 'Pasa el mouse por encima para revelar'}
                      </p>
                    </div>
